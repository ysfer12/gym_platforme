            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        <h1 class="text-3xl font-bold">Create New Subscription</h1>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" name="price" id="price" min="0" step="0.01" value="{{ old('price') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    @error('price')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="date" name="start_date" id="start_date" value="{{ old('start_date', date('Y-m-d')) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" onchange="updateEndDate()">
                                    </div>
                                    @error('start_date')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="transaction_number" id="transaction_number" value="{{ old('transaction_number') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" name="max_sessions_count" id="max_sessions_count" min="0" value="{{ old('max_sessions_count') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" name="sessions_left" id="sessions_left" min="0" value="{{ old('sessions_left') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    @error('sessions_left')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
...
<script>
    ...
    function updateSubscriptionDefaults() {
        const typeInput = document.getElementById('type');
        const durationInput = document.getElementById('duration');
        const maxSessionsInput = document.getElementById('max_sessions_count');
        const sessionsLeftInput = document.getElementById('sessions_left');
        const trainerZoneAccess = document.getElementById('trainer_zone_access');
        
        if (typeInput.value && durationInput.value) {
            const type = typeInput.value;
            const duration = parseInt(durationInput.value);
            
            // Set default sessions based on subscription type and duration
            if (type === 'Basic') {
                maxSessionsInput.value = 8 * duration;
                sessionsLeftInput.value = 8 * duration;
                trainerZoneAccess.checked = false;
            } else if (type === 'Premium') {
                maxSessionsInput.value = 12 * duration;
                sessionsLeftInput.value = 12 * duration;
                trainerZoneAccess.checked = true;
            } else if (type === 'Elite') {
                maxSessionsInput.value = 999; // Unlimited
                sessionsLeftInput.value = 999;
                trainerZoneAccess.checked = true;
            }
