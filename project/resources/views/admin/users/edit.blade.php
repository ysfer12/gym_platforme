                ...
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-indigo-100">Update user information and settings</p>
                        </div>
            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="firstname" id="firstname" value="{{ old('firstname', $user->firstname) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="lastname" id="lastname" value="{{ old('lastname', $user->lastname) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-1">
                                        <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" autocomplete="email" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                    </div>
                                </div>

                                <!-- Password - Optional on edit -->
                                <div class="sm:col-span-3">
                                    <label for="password" class="block text-sm font-medium text-gray-700">Password <span class="text-sm text-gray-500">(leave blank to keep current)</span></label>
                                    <div class="mt-1">
                                        <input type="password" name="password" id="password" autocomplete="new-password" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="password" name="password_confirmation" id="password_confirmation" autocomplete="new-password" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="address" name="address" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('address', $user->address) }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <a href="{{ route('admin.users') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-2">
                                Cancel
                            </a>
                ...
                <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Membership Information</h3>
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            ...
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    @if(isset($activeSubscription))
                                        ...
                                        {{ $activeSubscription->type }} - Expires: {{ \Carbon\Carbon::parse($activeSubscription->end_date)->format('M d, Y') }}
                                    @else
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            No active subscription
                                        </span>
                                    @endif
                                    <a href="{{ route('admin.subscriptions.create', ['user_id' => $user->id]) }}" class="ml-4 inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200">
                                        Add Subscription
                                    </a>
                                </dd>
                            </div>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">Attendance (Last 30 days)</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    {{ $attendanceCount ?? 0 }} sessions
                                    <a href="{{ route('admin.attendances.index', ['user_id' => $user->id]) }}" class="ml-4 inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200">
                                        View Attendance
                                    </a>
                                </dd>
                            </div>
                ...
                <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            <!-- Upcoming Sessions -->
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">Upcoming Sessions</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    {{ $upcomingSessions ?? 0 }} scheduled sessions
                                    <a href="{{ route('admin.sessions.index', ['trainer_id' => $user->id]) }}" class="ml-4 inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200">
                                        View Sessions
                                    </a>
                                </dd>
                            </div>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <!-- This would be from an additional field in your user or trainer details table -->
                            ...
                            <!-- Total Sessions Led -->
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">Total Sessions Led</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
