    ...
    <div class="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-auto">
        ...
        <div class="mt-6 relative flex-1 px-4 sm:px-6">
            <nav class="flex-1 space-y-1">
                ...
                <a href="{{ route('trainer.profile') }}" class="{{ request()->routeIs('trainer.profile*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-3 py-3 text-base font-medium rounded-md">
