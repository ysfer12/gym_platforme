        ...
        <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
            ...
            <div class="mt-5 flex-grow flex flex-col">
                <nav class="flex-1 px-2 space-y-1 bg-white" aria-label="Sidebar">
                    ...
                    <!-- Sessions Link -->
                    <a href="{{ route('member.sessions.book') }}" class="{{ request()->routeIs('member.sessions.book') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <svg class="mr-3 flex-shrink-0 h-6 w-6 {{ request()->routeIs('member.sessions.book') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
