...
<!-- Trainer Badge with QR Code Section - Replace this section in trainer.blade.php -->
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
    <div class="px-4 py-5 sm:px-6">
    ...
    <div class="border-t border-gray-200">
        <div class="px-4 py-5 sm:p-6">
            ...
            @php
                ...
                <div class="relative">
                    <div class="p-1 h-40 w-40 rounded-lg bg-gradient-to-r {{ $badgeClass }} border-2 flex items-center justify-center">
                ...
                <div class="mt-2">
                    <a href="{{ route('trainer.profile') }}" class="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        View Full Badge
                    </a>
                </div>
            </div>
