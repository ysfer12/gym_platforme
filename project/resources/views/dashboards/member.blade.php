                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="bg-white overflow-hidden shadow rounded-lg">
                            ...
                            <div class="bg-gray-50 px-5 py-3">
                                <div class="text-sm">
                                    <a href="{{ route('member.sessions.book') }}" class="font-medium text-indigo-600 hover:text-indigo-500">View all sessions</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                                    ...
                                    <a href="{{ route('member.sessions.book') }}" class="inline-flex items-center text-sm font-semibold text-indigo-600 hover:text-indigo-900">
                                        View all
                            ...
                            <div class="lg:hidden bg-white shadow overflow-hidden sm:rounded-lg">
                                ...
                                <div class="border-t border-gray-200">
                                    <div class="grid grid-cols-2 divide-x divide-y divide-gray-200">
                                        <a href="{{ route('member.sessions.book') }}" class="text-center p-4 hover:bg-gray-50">
