            ...
            <div class="py-6">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('receptionist.attendances.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        <form action="{{ route('receptionist.attendances.index') }}" method="GET">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
                                <div>
                                    ...
                                    <input type="date" name="date" id="date" value="{{ request('date') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div>
                                    <label for="session_id" class="block text-sm font-medium text-gray-700">Session</label>
                                    <select id="session_id" name="session_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                ...
                                <div class="flex items-end">
                                    ...
                                    <a href="{{ route('receptionist.attendances.index') }}" class="ml-3 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                        Reset
                                    </a>
                                </div>
                            </div>
                                    ...
                                    @forelse($attendances as $attendance)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('receptionist.attendances.show', $attendance->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                                <a href="{{ route('receptionist.attendances.edit', $attendance->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
