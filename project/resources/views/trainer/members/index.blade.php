        ...
        <div class="flex-1 overflow-auto">
            ...
            <div class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <h1 class="text-2xl font-semibold text-gray-900">Members in Your Sessions</h1>
                </div>
            </div>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-md">
                    <ul role="list" class="divide-y divide-gray-200">
                        @forelse($members as $member)
                            <li>
                                <a href="{{ route('trainer.members.show', $member->id) }}" class="block hover:bg-gray-50">
                        ...
                        @empty
                            <li class="px-4 py-5 sm:px-6">
                                <div class="text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">No members have attended your sessions yet.</p>
                                </div>
                            </li>
                        @endforelse
                    </ul>
